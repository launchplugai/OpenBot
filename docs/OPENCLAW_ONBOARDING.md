...
EXECUTIVE (Kimi 2.5 — Coordinator)
  ...
  │
  ├── MIDDLE MANAGEMENT (4× Kimi 128K — Sub-agent Masters)
  ...
  │   │
  │   └── WORKERS (4× Claude Code CLI — Opus 4.6)
  ...
  │
  └── OPERATIONS (4× GPT-4o-mini — Routine Workers)
